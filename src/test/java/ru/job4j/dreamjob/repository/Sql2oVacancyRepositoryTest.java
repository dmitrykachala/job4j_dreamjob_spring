...
class Sql2oVacancyRepositoryTest {
    ...
    void whenSaveSeveralThenGetAll() {
        var vacancy1 = sql2oVacancyRepository.save(new Vacancy(0, "title1", "description1", true,
                1, file.getId()));
        var vacancy2 = sql2oVacancyRepository.save(new Vacancy(0, "title2", "description2", false,
                1, file.getId()));
        var vacancy3 = sql2oVacancyRepository.save(new Vacancy(0, "title3", "description3", true,
                1, file.getId()));
    ...
    void whenDeleteThenGetEmptyOptional() {
        var vacancy = sql2oVacancyRepository.save(new Vacancy(0, "title", "description", true,
                1, file.getId()));
